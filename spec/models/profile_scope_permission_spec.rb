...
describe ProfileScopePermission do 
  ...
  it "should return an error if the profile is empty" do
    expect( FactoryGirl.build(:profile_scope_permission, profile: nil) ).to have(1).error_on(:profile)
  end
  ...
  it "should return an error if the scope permission is empty" do
    expect( FactoryGirl.build(:profile_scope_permission, scope_permission: nil) ).to have(1).error_on(:scope_permission)
  end
