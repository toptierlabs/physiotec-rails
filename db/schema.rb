...
ActiveRecord::Schema.define(:version => 20140220164817) do
  ...
  create_table "exercise_media", :force => true do |t|
  ...
  add_index "exercise_media", ["api_license_id"], :name => "index_exercise_media_on_api_license_id"
  add_index "exercise_media", ["owner_id"], :name => "index_exercise_media_on_owner_id"

  create_table "exercise_medium_illustrations", :force => true do |t|
  ...
  add_index "exercise_medium_illustrations", ["exercise_medium_id"], :name => "index_exercise_medium_illustrations_on_exercise_medium_id"

  create_table "exercise_medium_images", :force => true do |t|
    t.integer  "exercise_medium_id"
    t.string   "image"
    t.datetime "created_at",         :null => false
    t.datetime "updated_at",         :null => false
  ...
  add_index "exercise_medium_images", ["exercise_medium_id"], :name => "index_exercise_medium_images_on_exercise_medium_id"

  create_table "exercise_medium_translations", :force => true do |t|
    t.integer  "exercise_medium_id"
    t.string   "locale",             :null => false
    t.datetime "created_at",         :null => false
    t.datetime "updated_at",         :null => false
  ...
  add_index "exercise_medium_translations", ["exercise_medium_id"], :name => "index_exercise_medium_translations_on_exercise_medium_id"
  add_index "exercise_medium_translations", ["locale"], :name => "index_exercise_medium_translations_on_locale"

  create_table "exercise_medium_videos", :force => true do |t|
    t.integer  "exercise_medium_id"
    t.string   "video"
    t.string   "token"
    t.datetime "created_at",         :null => false
  ...
  add_index "exercise_medium_videos", ["exercise_medium_id"], :name => "index_exercise_medium_videos_on_exercise_medium_id"
